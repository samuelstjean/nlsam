...
def buildArgsParser():
    ...
    p.add_argument('-sigma', action='store', required=True, type=str,
    ...
    p.add_argument('--no_symmetry', dest='no_symmetry', action='store_true',
                   ...
                   'i.e. All points (x,y,z) on the sphere and (-x,-y,-z) were acquired, like in DSI.')
    return p
...
def main():
    ...
    if rest_of_b0s is not None:
        ...
        data_denoised_insert = np.empty(orig_shape, data_denoised.dtype)
        n = 0
