...
nlsam_denoising dwi_crop.nii.gz dwi_nlsam.nii.gz 1 bvals bvecs 5 -m mask_crop.nii.gz -f --sh_order 0 --noise_est noise_map --noise_map noise.nii.gz --cores 1 --noise_mask pmask.nii.gz
check_return_code $?

nlsam_denoising dwi_crop.nii.gz dwi_nlsam.nii.gz 1 bvals bvecs 5 -m mask_crop.nii.gz -f --sh_order 0 --noise_est noise_map --noise_map noise.nii.gz --no_stabilization --no_denoising
check_return_code $?

# Test on niftis
gunzip dwi_crop.nii.gz mask_crop.nii.gz

nlsam_denoising dwi_crop.nii.gz dwi_nlsam.nii.gz 1 bvals bvecs 5 -m mask_crop.nii.gz -f --sh_order 0 --no_stabilization --load_sigma sigma.nii.gz --is_symmetric
check_return_code $?

nlsam_denoising dwi_crop.nii.gz dwi_nlsam.nii.gz 1 bvals bvecs 5 -m mask_crop.nii.gz -f --sh_order 0 --no_denoising --save_sigma sigma.nii.gz --save_stab stab.nii.gz
check_return_code $?
