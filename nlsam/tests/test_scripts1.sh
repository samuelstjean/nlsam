...
nlsam_denoising dwi_crop.nii dwi_nlsam.nii 1 bvals bvecs 5 -m mask_crop.nii -f --verbose --no_denoising --save_sigma sigma.nii --save_stab stab.nii --load_mhat dwi_crop.nii
check_return_code $?
