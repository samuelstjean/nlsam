...
def test_reshaping():
    ...
    a = rng.integers(0, 10000, size=(30, 30, 30))
    ...
    b = rng.integers(0, 10000, size=(30, 30, 30, 10))
    ...
    a = rng.random(1000).reshape(10, 10, 10)
    ...
    a = rng.random(100000).reshape(10, 100, 10, 10)
    ...
    a = rng.random(10000).reshape(10, 10, 10, 10)
