...
install_requires = ['numpy>=1.15.4',
                    ...
                    'spams @ https://github.com/samuelstjean/spams-python/releases/download/v2.6.1/spams-2.6-cp27-cp27m-win_amd64.whl#egg=spams-2.6 ; platform_system=="Windows" ; python_version=="2.7"',
                    'spams @ https://github.com/samuelstjean/spams-python/releases/download/v2.6.1/spams-2.6-cp35-cp35m-win_amd64.whl#egg=spams-2.6 ; platform_system=="Windows" ; python_version=="3.5"',
                    'spams @ https://github.com/samuelstjean/spams-python/releases/download/v2.6.1/spams-2.6-cp36-cp36m-win_amd64.whl#egg=spams-2.6 ; platform_system=="Windows" ; python_version=="3.6"',
                    'spams @ https://github.com/samuelstjean/spams-python/releases/download/v2.6.1/spams-2.6-cp37-cp37m-win_amd64.whl#egg=spams-2.6 ; platform_system=="Windows" ; python_version=="3.7"',
                    'spams @ https://github.com/samuelstjean/spams-python/releases/download/v2.6.1/spams-2.6-cp38-cp38-win_amd64.whl#egg=spams-2.6 ; platform_system=="Windows" ; python_version=="3.8"',
                    'dipy>=0.11']
